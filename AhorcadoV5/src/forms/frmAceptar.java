 ...
 */
public class frmAceptar extends javax.swing.JDialog
{

    public boolean isDialogResult = false;
    public boolean isCancel = false;

    public frmAceptar(java.awt.Frame parent, boolean modal, String texto)
    {
        super(parent, modal);
    ...
    private void initComponents()
    {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(btnAceptar, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(frmAceptar.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                frmAceptar dialog = new frmAceptar(new javax.swing.JFrame(), true, null);
